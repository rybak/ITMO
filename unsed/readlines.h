...
// struct RL;
//
// // Принимает файловый дескриптор и максимальный размер строки, которую
// требуется
...
// // спрятанный внутри. Возвращает $0$, если всё хорошо или $-1$ в случае
// ошибки.
...
// // в rl в буфер buf.
// // * В случае успеха записывает строку в buf (включая перевод строки)
// и возвращает
...
// // возвращает $-3$. Несколько последующих вызовов также могут возвращать
// $-3$
...
// // * В остальных случаях возвращает $-1$, устанавливая errno в код
// произошедшей
// // ошибки.
